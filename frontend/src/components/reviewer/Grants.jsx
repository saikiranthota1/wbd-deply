...
const Grants = () => {
  ...
  const fetchGrants = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BACKENDURL}/review/${reviewer}/grantreviews`);
  ...
  const handleSubmitReview = async (appId) => {
    try {
      await axios.post(`${process.env.REACT_APP_BACKENDURL}/review/grants/${appId}/${reviewer}`, {
        rating,
        comment
      });
