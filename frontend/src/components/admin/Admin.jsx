...
export default function Admin() {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKENDURL}/admin/startups`)
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKENDURL}/admin/eir-requests`)
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKENDURL}/admin/grant-requests`)
      .then((response) => response.json())
