...
export default function GrantsReviewerSelection({ params }) {
  ...
  const fetchGrantdata = async () => {
    try {
      const response = await fetch(`${process.env.REACT_APP_BACKENDURL}/admin/grant/${id}`);
  ...
  const fetchReviewers = async () => {
    try {
      const response = await fetch(`${process.env.REACT_APP_BACKENDURL}/review/reviewers`);
