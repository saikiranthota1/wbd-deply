...
export default function Reviewers() {
  ...
  useEffect(() => {
    const fetchReviewers = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_BACKENDURL}/review/reviewers`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKENDURL}/review/add-reviewer`, newReviewer);
